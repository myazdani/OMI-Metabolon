...
aic.sorted = linear_classifiers.errors$variable[order(linear_classifiers.errors$AIC)[c(1:50)]]


top10.df = subset(df.m, variable %in% intercepts.sorted$variable[c(1:50)])
